...
class ReportViewState extends State<ReportView> {
  ...
  Future<void> _submitReport(BuildContext context, Rental rental) async {
    if (_formKey.currentState!.validate()) {
      ...
      bool success =
          await controller.submitReport(rental, description, _selectedImage!);
      ...
      if (success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Schadeformulier verzonden'),
          ),
        );
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Er is iets mis gegean, probeer het later nog eens.'),
          ),
        );
      }
    }
